...
class _HomepageState extends State<Homepage> {
  ...
  List<MostVisted> mostVisitedCategories = [
    MostVisted('Buildings', [
      ...
      Place('Round Building', "assets/images/ac.JPG", 'Kigali,Rwanda', 'Round Building'),
      Place(
          'Nairobi Tower', "assets/images/Image1.PNG", 'Kigali,Rwanda', 'Nairobi Tower'),
    ...
    MostVisted('Beach', [
      Place(
          'Kenya Long Beach', "assets/images/saga.JPG", 'Kigali,Rwanda', 'Kenya Long Beach'),
      Place('Tamu-Tamu Beach', "assets/images/tm.JPG", 'Kigali,Rwanda', 'Tamu-Tamu Beach'),
      Place(
          'Saga Plage Burundi', "assets/images/bc.JPG", 'Kigali,Rwanda', 'Saga Plage Burundi'),
      Place('Tamu-Tamu Beach', "assets/images/pb.JPG", 'Kigali,Rwanda', 'Tamu-Tamu Beach'),
      Place(
          'Saga Plage Burundi', "assets/images/mb.JPG", 'Kigali,Rwanda', 'Saga Plage Burundi'),
      Place('Kenya Long Beach', "assets/images/wb.JPG", 'Kigali,Rwanda', 'Kenya Long Beach'),
    ]),
    MostVisted('Volcanoes', [
      Place('Mount Nyiragongo', "assets/images/vc.JPG", 'Kigali,Rwanda', 'Mount Nyiragongo'),
      Place('Mount Kalisimbi', "assets/images/rw.JPG", 'Kigali,Rwanda', 'Mount Kalisimbi'),
      Place('Mount Muhabura', "assets/images/vc2.JPG", 'Kigali,Rwanda', 'Mount Muhabura'),
      Place('Mount Sabyinyo', "assets/images/vc3.JPG", 'Kigali,Rwanda', 'Mount Sabyinyo'),
      Place('Mount Bisoke', "assets/images/vc4.JPG", 'Kigali,Rwanda', 'Mount Bisoke'),
      Place('Mount Kilimandjalo', "assets/images/vc5.JPG", 'Kigali,Rwanda',
          'Mount Kilimandjalo'),
    ]),
    MostVisted('Canopy', [
      Place('Nyungwe Canopy', "assets/images/cnp.JPG", 'Kigali,Rwanda', 'Nyungwe Canopy'),
      Place('DRC Canopy', "assets/images/cp.JPG", 'Kigali,Rwanda', 'DRC Canopy'),
      Place('Tanzania Canopy', "assets/images/cp2.JPG", 'Kigali,Rwanda', 'Tanzania Canopy'),
      Place('South Sudan Canopy', "assets/images/cp3.JPG", 'Kigali,Rwanda',
          'South Sudan Canopy'),
      Place('SouthAfrica Canopy', "assets/images/cp4.JPG", 'Kigali,Rwanda',
          'SouthAfrica Canopy'),
      Place('Gabon Canopy', "assets/images/cp5.JPG", 'Kigali,Rwanda', 'Gabon Canopy'),
    ]),
    MostVisted('Parks', [
      ...
      Place('Kenyan National Park', "assets/images/kp4.JPG", 'Kigali,Rwanda',
          'Kenyan National Park'),
      Place(
          'DRC National Park', "assets/images/kp5.JPG", 'Kigali,Rwanda', 'DRC National Park'),
    ]),
  ];
