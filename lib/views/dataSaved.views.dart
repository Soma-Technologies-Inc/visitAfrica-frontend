...
class SavedData extends StatefulWidget {
  ...
  const SavedData({Key key, this.mydata, this.thehall, this.service,this.service1,this.service2})
      : super(key: key);
  @override
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      children: <Widget>[
                        Text(
                          "Hospitality Industry Name:   " + '${widget.thehall}',
                          style: TextStyle(
                            fontSize: 16.0,
                          ),
                        ),
                  ...
                  Container(
                    ...
                    child: Row(
                      children: <Widget>[
                        Text("Service provided : " + '${widget.service}'+","+ '${widget.service1}'+ ","+ '${widget.service2}'),
                      ],
                    ),
                  ),      Container(
                    alignment: Alignment.bottomCenter,
